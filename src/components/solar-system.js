    ...
    <main role="main" className="pure-u-1">
      ...
      <div id="dataArea" className="solar-system pure-u-1">
        <div id="solarsystemTable">
          ...
          <div id="innerPlanets" className="type-1 group pure-u-1">
            ...
            <div id="earth" className="type-2 pure-u-md-5-6 pure-lg-4-5">
              ...
              <div id="nearEarthObjects" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
            ...
            <div id="mars" className="type-2 pure-u-md-5-6 pure-lg-4-5">
              ...
              <div id="marsTrojanGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
                <a href="#" className="item-name">Mars-Trojaner</a>
              </div>
            </div>
            <div id="amorAsteroids" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
              ...
              <div id="amor2Asteroids" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="amor3Asteroids" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="amor4Asteroids" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
          ...
          <div id="asteroidBelt" className="type-1 group pure-u-1">
            <a href="#" className="item-name">Asteroidengürtel</a>
            <div id="innerMainbelt" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
              <a href="#" className="item-name collapsed">Innerer Hauptgürtel</a>
              <div id="floraGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="vestaGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="nysaGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
            ...
            <div id="middleMainbelt" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
              <a href="#" className="item-name collapsed">Mittlerer Hauptgürtel</a>
              <div id="eunomiaGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="gefionGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
            ...
            <div id="outerMainbelt" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
              <a href="#" className="item-name collapsed">Äußerer Hauptgürtel</a>
              <div id="koronisGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="eosGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="themisGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="hygieaGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
          ...
          <div id="outerPlanets" className="type-1 group pure-u-1">
            ...
            <div id="jupiter" className="type-2 pure-u-md-5-6 pure-lg-4-5">
              ...
              <div id="jupiterMoons" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="jupiterTrojans" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
                <a href="#" className="item-name">Jupiter-Trojaner</a>
              </div>
            </div>
            <div id="centaurs1" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
            ...
            <div id="saturn" className="type-2 pure-u-md-5-6 pure-lg-4-5">
              ...
              <div id="saturnMoons" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
            ...
            <div id="centaurs2" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
              <a href="#" className="item-name">Zentauren</a>
            </div>
            <div id="uranus" className="type-2 pure-u-md-5-6 pure-lg-4-5">
              <a href="#" className="item-name">Uranus</a>
              <div id="uranusMoons" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
            ...
            <div id="centaurs3" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
              <a href="#" className="item-name">Zentauren</a>
            </div>
            <div id="neptune" className="type-2 pure-u-md-5-6 pure-lg-4-5">
              <a href="#" className="item-name">Neptun</a>
              <div id="neptuneMoons" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="neptuneTrojans" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
                <a href="#" className="item-name">Neptun-Trojaner</a>
              </div>
            </div>
          </div>
          <div id="transneptunianObjects" className="type-1 group pure-u-1">
            <a href="#" className="item-name">Transneptunische Objekte (TNO)</a>
            <div id="kuiperbelt" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
              <a href="#" className="item-name collapsed">Kuipergürtel</a>
              <div id="kuiperbeltObjects" className ="type-3 group pure-u-md-4-5 pure-lg-3-4">
              ...
              <div id="sednoidGroup" className="type-3 group pure-u-md-4-5 pure-lg-3-4">
          ...
          <div id="comets" className="type-1 group pure-u-1">
            <a href="#" className="item-name">Kometen</a>
            <div id="periodicComets" className="type-2 group pure-u-md-5-6 pure-lg-4-5">
          ...
          <div id="oortCloud" className="type-1 group pure-u-1">
