      ...
      <div id="dataArea" className="solar-system pure-u-1">
        <div id="solarsystemTable">
          ...
          <div id="innerPlanets" className="type-1 pure-u-1">
            ...
            <div id="atenAsteroids" className="type-2 pure-u-4-5">
            ...
            <div id="apolloAsteroids" className="type-2 pure-u-4-5">
            ...
            <div id="amorAsteroids" className="type-2 pure-u-4-5">
              ...
              <div id="amor2Asteroids" className="type-3 pure-u-3-4">
              ...
              <div id="amor3Asteroids" className="type-3 pure-u-3-4">
              ...
              <div id="amor4Asteroids" className="type-3 pure-u-3-4">
          ...
          <div id="asteroidBelt" className="type-1 pure-u-1">
            ...
            <div id="innerMainbelt" className="type-2 pure-u-4-5">
              <a href="#" className="item-name collapsed">Innerer Hauptgürtel</a>
              <div id="floraGroup" className="type-3 pure-u-3-4">
              ...
              <div id="vestaGroup" className="type-3 pure-u-3-4">
              ...
              <div id="nysaGroup" className="type-3 pure-u-3-4">
            ...
            <div id="middleMainbelt" className="type-2 pure-u-4-5">
              <a href="#" className="item-name collapsed">Mittlerer Hauptgürtel</a>
              <div id="eunomiaGroup" className="type-3 pure-u-3-4">
              ...
              <div id="gefionGroup" className="type-3 pure-u-3-4">
            ...
            <div id="outerMainbelt" className="type-2 pure-u-4-5">
              <a href="#" className="item-name collapsed">Äußerer Hauptgürtel</a>
              <div id="koronisGroup" className="type-3 pure-u-3-4">
              ...
              <div id="eosGroup" className="type-3 pure-u-3-4">
              ...
              <div id="themisGroup" className="type-3 pure-u-3-4">
              ...
              <div id="hygieaGroup" className="type-3 pure-u-3-4">
          ...
          <div id="outerPlanets" className="type-1 pure-u-1">
            ...
            <div id="jupiter" className="type-2 pure-u-4-5">
              ...
              <div id="jupiterMoons" className="type-3 pure-u-3-4">
            ...
            <div id="saturn" className="type-2 pure-u-4-5">
              ...
              <div id="saturnMoons" className="type-3 pure-u-3-4">
            ...
            <div id="uranus" className="type-2 pure-u-4-5">
              ...
              <div id="uranusMoons" className="type-3 pure-u-3-4">
            ...
            <div id="neptune" className="type-2 pure-u-4-5">
              ...
              <div id="neptuneMoons" className="type-3 pure-u-3-4">
          ...
          <div id="transneptunianObjects" className="type-1 pure-u-1">
            ...
            <div id="kuiperbelt" className="type-2 pure-u-4-5">
              ...
              <div id="sednoidGroup" className="type-3 pure-u-3-4">
