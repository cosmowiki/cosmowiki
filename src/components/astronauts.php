<?php include("header.php")?>
	<main role="main" class="pure-u-2-3">
		<div id="featured" class="astronauts center">
			<h1>Raumfahrer</h1>
			<p>Pioniere, Wegbereiter, Vision&auml;re</p>
		</div>
...
personDescript, personLink, type FROM persons WHERE type = '2' ORDER by personName";
