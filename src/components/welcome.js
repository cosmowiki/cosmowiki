      ...
      <div id="welcomeArea" class="pure-u-1">
          <div id="presentationEvents" class="welcome-container pure-u-1">
          	<div class="welcome">
          		<h4>7. Januar 1610</h4>
          		<p>
        	  	        An diesem Tag entdeckte Galileo Galilei in Padua mit einem
                      Nachbau des nur ein Jahr zuvor von Hans Lipperhey in Holland
                      erfundenen Fernrohres die vier größten Monde des Jupiter - Io,
                      Europa, Ganymed und Kallisto.  Seine Beobachtungen und bahnbrechenden
                      Erkenntnisse über den Mond, das Jupiter-System und die Sterne
                      veröffentlichte er noch im gleichen Jahr in seinem
                      Werk <i>"Sidereus nuncius"</i>. Die Ringe des Saturn deutete
                      er übrigens als Henkel des Planeten ;-)
        	  	</p>
        	  	<p>
        	  	  Weitere {[numberOfEvents]-1} Ereignisse aus der spannenden Geschichte
          ...
          <div id="presentationScientists" class="presentation-container pure-u-1 pure-u-md-1-2">
          	<div class="presentation">
                ...
                mehr: {[countScientists]-[countAstronomers]} weitere Wissenschaftler - Physiker,
          ...
          <div id="presentationAstronauts" class="presentation-container pure-u-1 pure-u-md-1-2">
          	<div class="presentation">
          		...
          		<p>
          			Eine unglaubliche Zahl! So viele Stunden haben alle {[countAstronauts]}
