...
const Navigation = ({ appUrl }) => {
  return (
    <div id="desktopMenus">
      <div id="desktopMenuContainer" className="pure-u-lg-2-3">
        <nav id="desktopMenu" className="pure-menu pure-menu-horizontal center">
      ...
      <div id="desktopMenu2Container" className="pure-u-md-1-4 pure-u-lg-1-6 right">
        <div id="desktopMenu2" className="pure-menu pure-menu-horizontal">
          <ul className="pure-menu-list">
            <li id="toggleSearch" className="pure-menu-item pure-menu-has-children pure-menu-allow-hover">
